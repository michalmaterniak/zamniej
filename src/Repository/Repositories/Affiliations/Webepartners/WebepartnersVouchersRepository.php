...
use App\Entity\Entities\Affiliations\Webepartners\WebepartnersVouchers as Entity;
 ...
 */
class WebepartnersVouchersRepository extends WebepartnersOffersRepository
{
    ...
    {
        $this->queryBuilder
            ->andWhere("{$this->getRootAlias()}.voucherId = :idWebe")
     ...
     * @return WebepartnersVouchersRepository
