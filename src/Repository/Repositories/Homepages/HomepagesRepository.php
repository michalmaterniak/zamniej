<?php
namespace App\Repository\Repositories\Homepages;

use App\Entity\Entities\Homepages\Homepages as Entity;
 ...
 */
class HomepagesRepository extends PageResourceRepository
{
