...
class IdParentAsIdResourceRequestModifierQuery extends ModifierQuery
{
...
//        $queryBuilder->leftJoin("{$this->rootAlias}.parent", 'parent')->addSelect('parent');
        $queryBuilder->andWhere($this->rootAlias . '.idResource = :idParent')->setParameter('idParent', $this->idParent);
