...
/**
 * Class WebepartnersVouchers
 * @ORM\Table(name="webepartners_vouchers")
 * @ORM\Entity(repositoryClass="App\Repository\Repositories\Affiliations\Webepartners\WebepartnersVouchersRepository")
 */
class WebepartnersVouchers extends OffersAffiliation implements OfferVoucherInterface
{
     ...
     * @ORM\Column(name="voucher_code", type="string", length=200, nullable=true)
     */
    ...
    {
        $this->voucherText = $voucherText ?: "Kupon Rabatowy " . $this->getProgramName();
    }
