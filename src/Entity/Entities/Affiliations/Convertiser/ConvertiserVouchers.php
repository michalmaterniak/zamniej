...
/**
 * Class ConvertiserVouchers
 * @ORM\Table(name="convertiser_vouchers")
 * @ORM\Entity(repositoryClass="App\Repository\Repositories\Affiliations\Convertiser\ConvertiserVouchersRepository")
 */
class ConvertiserVouchers extends OffersAffiliation implements OfferVoucherInterface
{
    /**
     * @param string $field
     * @return string
    ...
    /**
     * @var string $id
     * @ORM\Column(name="id", type="string", length=50, nullable=false, unique=true)
     */
    protected $id;
