...
<!--            </div>-->
<!--            <div class="col-md-9">-->
<!--              <input type="text" class="form-control" v-model="value.group">-->
<!--            </div>-->
<!--            &lt;!&ndash;      <img v-if="filepath" :src="filepath" style="width: 60px; height: 60px">&ndash;&gt;-->
<!--          </div>-->
        </div>
      </div>
    </div>
 ...
 import photos from "../../../mixins/Photo/photos";
    export default {
      ...
      methods:
      {
        ...
        openFilesManager()
        {
          // this.openPopup('Menadżer plików', {
          //   template: PopupFilesManager,
          //   data:{
          //     urlManager: this.urlFileManager
          //   }
          // })
