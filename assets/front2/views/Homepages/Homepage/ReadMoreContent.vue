<template>
  <div class="row product-para text-justify" :class="{'pointer' : !isShowContent}">
    <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12" @click="showContent">
      <div v-html="lead"></div>
    </div>
    <div :class="{'lazy-d-none' : !isShowContent}" class=" col-sm-12 col-xs-12 col-md-12 col-lg-12">
