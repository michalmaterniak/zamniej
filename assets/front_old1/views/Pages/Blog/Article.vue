<template>
<div v-if="$store.getters.typePage === 'Pages-Blog-Article'">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                  <figure>
                    <img :src="model.subpage.header.modifyPath" :alt="model.subpage.header.original.data.alt">
                  </figure>
                  <div class="col-md-12">
                    <div class="row">
                      <div class="blog-details">
                        <h4 class="hover capital marB10" v-text="model.subpage.subpage.name">post title here</h4>
                        <ul class="marB10 fonts">
                          <li class="hover"><a href="#"><font-awesome-icon icon="calendar"/> <span v-text="$moment(model.subpage.subpage.datetimeCreate).format('ll')"></span></a></li>
<!--                          <li class="marL10 upper hover"><a href="#"><i class="fa fa-comment" aria-hidden="true"></i> comments</a></li>-->
                        </ul>

                        <div v-html="model.subpage.subpage.content.content">
...
<!--                      <a href="#"><span class="orange">jon doe</span></a><a href="#"> 4 Nov-2017</a>-->
...
<!--                      <a href="#" class="orange"><span><i class="fa fa-reply" aria-hidden="true"></i> reply</span></a>-->
<!--                    </div>-->
...
<!--                <h4 class="orange capital marB10"><a href="#">Latest tweets</a></h4>-->
<!--                <h5 class="marB5"><i class="fa fa-twitter orange" aria-hidden="true"></i> @Blackfriday.com</h5>-->
<!--                <p>Lorem ipsum dolor sit acons tuadip iscing elit Fusce</p>-->
<!--                <span class="orange">www.itg.Com</span>-->
<!--                <p>4 hour ago</p>-->
<!--                <h4 class="orange capital marB10 marT30"><a href="#">Latest tweets</a></h4>-->
<!--                <h5 class="marB5"><i class="fa fa-twitter orange" aria-hidden="true"></i> @Blackfriday.com</h5>-->
<!--                <p>Lorem ipsum dolor sit acons tuadip iscing elit Fusce</p>-->
<!--                <span class="orange">www.itg.Com</span>-->
<!--                <p>4 hour ago</p>-->
...
<!--                <h4 class="orange capital marB10"><a href="#">Trending Offers</a></h4>-->
<!--                <div class="trending">-->
...
<!--                      <h5 class="orange"><a href="#"><span>Read More</span></a></h5>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
<!--                <div class="trending">-->
