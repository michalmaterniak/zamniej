 ...
 */
final class Version20201108094756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offers ADD CONSTRAINT FK_DA46042784A0A3ED FOREIGN KEY (content_id) REFERENCES contents (id_content) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE offers ADD CONSTRAINT FK_DA4604277E9E4C8C FOREIGN KEY (photo_id) REFERENCES files (id_file) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE resources ADD CONSTRAINT FK_EF66EBAE642B8210 FOREIGN KEY (admin_id) REFERENCES resources_config (id_resource_admin) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE files_resources ADD CONSTRAINT FK_97948C1589329D25 FOREIGN KEY (resource_id) REFERENCES resources (id_resource) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE subpages ADD CONSTRAINT FK_5AC70AAF97E3DD86 FOREIGN KEY (seo_id) REFERENCES seo_subpage (id_seo) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE slides ADD CONSTRAINT FK_B8C020917E9E4C8C FOREIGN KEY (photo_id) REFERENCES files (id_file) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE slides ADD CONSTRAINT FK_B8C0209153C674EE FOREIGN KEY (offer_id) REFERENCES offers (id_offer) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE webepartners_vouchers ADD CONSTRAINT FK_1225E7B153C674EE FOREIGN KEY (offer_id) REFERENCES offers (id_offer) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE webepartners_banners ADD CONSTRAINT FK_ABF911BC53C674EE FOREIGN KEY (offer_id) REFERENCES offers (id_offer) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE webepartners_promotions ADD CONSTRAINT FK_8F6F098853C674EE FOREIGN KEY (offer_id) REFERENCES offers (id_offer) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE webepartners_hot_prices ADD CONSTRAINT FK_6F9A91F553C674EE FOREIGN KEY (offer_id) REFERENCES offers (id_offer) ON DELETE CASCADE');
